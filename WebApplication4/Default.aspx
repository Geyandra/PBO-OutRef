<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Tugas_PBO.Poli" %>
...
<body>
    <form id="form1" runat="server">
            <table>
                ...
                <tr>
                    <td class="auto-style7"><p align="right">Poli ID&nbsp;&nbsp;&nbsp; </p></td>
                    <td class="auto-style1">:&nbsp;&nbsp;<asp:TextBox ID="txtPoliID" runat="server"></asp:TextBox>
                    </td>
                    <td>
                        &nbsp;</td>
                </tr>
                <tr>
                    <td class="auto-style7"><p align="right">Nama Poli&nbsp;&nbsp;&nbsp; </p></td>
                    <td class="auto-style1">:&nbsp;
                        <asp:TextBox ID="txtNamaPoli" runat="server"></asp:TextBox>
                    </td>
                    <td>
                        &nbsp;</td>
                </tr>
                <tr>
                    <td class="auto-style7"><p align="right">Jumlah Dokter&nbsp;&nbsp;&nbsp; </p></td>
                    <td class="auto-style1">:&nbsp;
                        <asp:TextBox ID="txtJumlahDokter" runat="server"></asp:TextBox>
                    </td>
                    <td>
                        &nbsp;</td>
                </tr>
            ...
            <table>
                <tr>
                    <td class="auto-style5">
                        <center><h1 class="auto-style4">Show all Poli Data</h1></center>
                    </td>
                </tr>
                <tr>
            ...
            <table>
                <tr>
                    ...
                    <tr>
                    <td class="auto-style7"><p align="right">Poli ID&nbsp;&nbsp;&nbsp; </p></td>
                    <td class="auto-style1">:&nbsp;&nbsp;<asp:TextBox ID="txtPolID" runat="server"></asp:TextBox>
                    </td>
                        <br />
                    </td>
                    <td>
